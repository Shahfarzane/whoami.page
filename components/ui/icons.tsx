...
export const Icons = {
  ...
  github: (props: IconProps) => (
    ...
    >
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M8 .685A7.5 7.5 0 0 0 5.63 15.302c.375.07.512-.163.512-.361 0-.179-.007-.77-.01-1.397-2.086.454-2.527-.884-2.527-.884-.34-.867-.832-1.098-.832-1.098-.68-.465.051-.455.051-.455.753.052 1.15.772 1.15.772.669 1.147 1.754.815 2.182.624.067-.485.262-.816.476-1.003-1.666-.19-3.417-.833-3.417-3.707 0-.818.293-1.487.773-2.013-.078-.189-.335-.951.073-1.984 0 0 .63-.202 2.062.768A7.186 7.186 0 0 1 8 4.312c.637.003 1.28.086 1.879.252 1.431-.97 2.06-.769 2.06-.769.408 1.033.152 1.796.074 1.985.48.525.772 1.194.772 2.013 0 2.88-1.755 3.515-3.425 3.7.27.233.509.69.509 1.39 0 1.003-.009 1.81-.009 2.058 0 .2.135.433.515.36A7.501 7.501 0 0 0 8 .684Z"
        clipRule="evenodd"
      ></path>
    </svg>
  ),
  ...
  xIcon: (props: IconProps) => (
    ...
    >
      <path
        fill="currentColor"
        d="M1.034 1.467 6.44 8.674 1 14.534h1.224l4.762-5.13 3.848 5.13H15L9.29 6.92l5.063-5.454H13.13L8.744 6.192 5.2 1.467H1.034Zm1.8.899h1.914L13.2 13.634h-1.913L2.834 2.366Z"
      ></path>
    </svg>
  ),
  ...
  searchEye: (props: IconProps | React.SVGProps<SVGSVGElement>) => (
    <svg
      width="24"
      height="24"
      viewBox="0 0 24 24"
    ...
    >
      <path
        d="M17.4279 16.1553L21.2826 20.0091L20.0091 21.2826L16.1553 17.4279C14.7214 18.5774 12.9378 19.2026 11.1 19.2C6.6288 19.2 3 15.5712 3 11.1C3 6.6288 6.6288 3 11.1 3C15.5712 3 19.2 6.6288 19.2 11.1C19.2026 12.9378 18.5774 14.7214 17.4279 16.1553ZM12.1602 7.6593C11.3919 7.42278 10.5666 7.45019 9.81574 7.73717C9.06487 8.02415 8.43165 8.55417 8.01696 9.2428C7.60228 9.93143 7.43 10.739 7.52758 11.5369C7.62516 12.3348 7.98697 13.0771 8.55537 13.6455C9.12378 14.2139 9.86607 14.5757 10.664 14.6733C11.4619 14.7709 12.2695 14.5986 12.9581 14.1839C13.6467 13.7693 14.1768 13.136 14.4637 12.3852C14.7507 11.6343 14.7781 10.809 14.5416 10.0407C14.4216 10.3059 14.239 10.5381 14.0095 10.7173C13.7801 10.8964 13.5106 11.0173 13.2242 11.0695C12.9378 11.1216 12.643 11.1035 12.3651 11.0167C12.0872 10.9299 11.8345 10.777 11.6287 10.5711C11.4229 10.3652 11.27 10.1125 11.1834 9.83456C11.0967 9.55664 11.0787 9.26184 11.1309 8.97544C11.1832 8.68904 11.3042 8.41959 11.4834 8.1902C11.6627 7.96081 11.8949 7.77833 12.1602 7.6584V7.6593Z"
        fill="currentColor"
      />
    </svg>
  ),
  ...
  information: (props: IconProps | React.SVGProps<SVGSVGElement>) => (
    <svg
      height="16"
      strokeLinejoin="round"
      viewBox="0 0 16 16"
  ...
  add: (props: IconProps | React.SVGProps<SVGSVGElement>) => (
    <svg
      {...props}
      height="16"
      strokeLinejoin="round"
  ...
  search2: (props: IconProps | React.SVGProps<SVGSVGElement>) => (
    <svg
      width="24"
      height="24"
      viewBox="0 0 24 24"
  ...
  homeIconLine: (props: IconProps | React.SVGProps<SVGSVGElement>) => (
    <svg
      {...props}
      width="24"
      height="24"
    ...
    >
      <path
        d="M14.78 21.25H9.21997V15.3C9.21997 14.75 9.66997 14.3 10.22 14.3H13.78C14.33 14.3 14.78 14.75 14.78 15.3V21.25V21.25Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  homeIconFilled: (props: IconProps | React.SVGProps<SVGSVGElement>) => (
    <svg
      {...props}
      width="24"
      height="24"
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M13.7414 1.95572C12.7284 1.1269 11.2716 1.1269 10.2586 1.95572L4.0086 7.06936C3.37022 7.59167 3 8.37293 3 9.19774V18.25C3 19.7688 4.23122 21 5.75 21H18.25C19.7688 21 21 19.7688 21 18.25V9.19774C21 8.37293 20.6298 7.59167 19.9914 7.06936L13.7414 1.95572ZM7.75 15.5C7.33579 15.5 7 15.8358 7 16.25C7 16.6642 7.33579 17 7.75 17H16.25C16.6642 17 17 16.6642 17 16.25C17 15.8358 16.6642 15.5 16.25 15.5H7.75Z"
        fill="currentColor"
      />
    </svg>
  ),
  user: (props: IconProps | React.SVGProps<SVGSVGElement>) => (
    <svg
      {...props}
      width="15"
      height="15"
  ...
  sateliteIcon: (props: IconProps | React.SVGProps<SVGSVGElement>) => (
    <svg
      {...props}
      width="24"
      height="24"
    ...
    >
      <path
        d="M2.75 12C2.75 17.1086 6.89137 21.25 12 21.25C13.5266 21.25 14.9669 20.8802 16.2361 20.2252C17.2709 19.6912 17.319 18.319 16.4956 17.4956L6.50437 7.50436C5.68098 6.68096 4.3088 6.72913 3.77479 7.76392C3.11983 9.03309 2.75 10.4734 2.75 12Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  createPlus: (props: IconProps | React.SVGProps<SVGSVGElement>) => (
    <svg
      {...props}
      width="24"
      height="24"
  ...
  newProfileIcon: (props: IconProps | React.SVGProps<SVGSVGElement>) => (
    <svg
      {...props}
      width="24"
      height="24"
    ...
    >
      <path
        d="M15.7511 6.5C15.7511 8.57107 14.0722 10.25 12.0011 10.25C9.93006 10.25 8.25113 8.57107 8.25113 6.5C8.25113 4.42893 9.93006 2.75 12.0011 2.75C14.0722 2.75 15.7511 4.42893 15.7511 6.5Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinejoin="round"
      />
